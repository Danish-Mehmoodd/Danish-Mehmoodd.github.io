...
(function(e, t) {
    ...
    if (s && Z) {
            ...
            var fe = function replace(e, t) {
                ...
                if (e !== null && typeof e !== "undefined") {
                    ...
                    if (typeof n !== "undefined") {
                        return te.Call(n, e, [r, t])
                    }
                }
                return te.Call(ue, r, [te.ToString(e), t])
            };
        ...
        if (!K.symbol(W.split)) {
            ...
            var le = function split(e, t) {
                ...
                return te.Call(ce, r, [te.ToString(e), t])
            };
    ...
    var dr = {
        ...
        clz32: function clz32(e) {
            ...
            return gr ? te.Call(gr, r) : 31 - k(L(r + .5) * Math.LOG2E)
        },
    ...
    h(Math, "asinh", dr.asinh, Math.asinh(-1e7) !== -Math.asinh(1e7));
    ...
    var mr = Math.round;
    var wr = Math.round(.5 - Number.EPSILON / 4) === 0 && Math.round(-.5 + Number.EPSILON / 3.99) === 1;
    var jr = pr + 1;
    var Sr = 2 * pr - 1;
    var Tr = [jr, Sr].every(function(e) {
